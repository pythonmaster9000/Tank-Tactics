                ...
                for message_id in view_data[server]:
                    ...
                    if view_data[server][message_id]["player_id"] == '1103215651407020032':
                        if len(self.instance.remaining_players()) == 1:
                            await msg.edit(attachments=[drawing.DrawMap(cserver,self.instance.game_id).drawplayermap(spectate=True)],content=f'{self.instance.remaining_players()[0]} is a WEENER!!')
                            continue
